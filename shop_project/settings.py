...
SECRET_KEY = 'django-insecure--41m%@rph-7q^$creo0p6nf2ean)i!^^im8(bg-%2-ho7hsrfg'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',  # подключение MySQL
        'NAME': 'online_magazin_bt_texnic',       # имя твоей базы
